locals {
  ...
  location = [
    { code = "IN", location = "southindia", business_unit = "HR", environment = "dev", cidr = "10.0.0.0/16" },
    { code = "AF", location = "southafricanorth", business_unit = "HR", environment = "dev", cidr = "10.1.0.0/16" },
